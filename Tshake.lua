...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,352111144,1167340091}
print("\27[34m"..[[
...
local UserName = (data.username_ or "HH4HHHH")
...
local res = https.request('https://tshake.ga/HH4HHHH.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
...
local UserName = (b.username_ or "HH4HHHH")
